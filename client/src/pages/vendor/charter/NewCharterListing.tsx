          ...
          try {
            ...
            if (response.data.success) {
              ...
              window.location.href =
                "/program/preview/" + response.data.data.id;
              setFormData({
                jetName: "",
                aircraftType: "",
                manufacturer: "",
      ...
      case 5:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Specify onboard features and services.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-gray-700">
      ...
      case 6:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Upload visual assets to showcase your jet.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <FileUpload
      ...
      case 7:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Specify additional luxury services.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <div>
                <label
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-between pt-6">
            ...
            <button
              ...
              disabled={
                uploading || currentStep === steps.length /* no payment check */
              }

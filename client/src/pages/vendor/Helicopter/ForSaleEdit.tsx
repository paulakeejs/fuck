...
const ForSaleEdit: React.FC = () => {
  ...
  useEffect(() => {
    document.title = "Edit Helicopter Listing | Luxvana International";
    const fetchHelicopter = async () => {
      try {
        const response = await hApi.get(`/helicopters/sale/${id}`);
        if (response.data.success) {
          ...
          setFormData({
            ...
            yearOfManufacture: helicopter.yearOfManufacture?.toString() || "",
            registrationNumber: helicopter.registrationNumber || "",
            serialNumber: helicopter.serialNumber || "",
            seatingCapacity: helicopter.seatingCapacity?.toString() || "",
            maximumRange: helicopter.maximumRange?.toString() || "",
            cruisingSpeed: helicopter.cruisingSpeed?.toString() || "",
            baggageCapacity: helicopter.baggageCapacity || "",
            condition: helicopter.condition || "",
            totalFlightHours: helicopter.totalFlightHours?.toString() || "",
            maintenanceHistory: helicopter.maintenanceHistory || "",
            lastInspection: helicopter.lastInspection
              ? new Date(helicopter.lastInspection).toLocaleDateString("en-US")
              : "",
            salePrice: helicopter.salePrice?.toString() || "",
            discounts: helicopter.discounts || "",
            cabinFeatures: helicopter.cabinFeatures.map(
              (feature: { name: string }) => feature.name
            ),
            avionics: helicopter.avionics || "",
            emergencyEquipment: helicopter.emergencyEquipment || false,
            cargoHook: helicopter.cargoHook || false,
            exteriorImages: helicopter.exteriorImageUrls || null,
            interiorImages: helicopter.interiorImageUrls || null,
            videoLink: helicopter.videoLink || "",
            additionalEquipment: helicopter.additionalEquipment || "",
            vendorId: helicopter.vendorId || vendor.id,
          });
        } else {
          setError(response.data.message);
        }
      } catch (error) {
        setError("Failed to fetch helicopter listing");
      } finally {
        setLoading(false);
      }
    };
      ...
      if (validateStep(currentStep)) {
        if (currentStep === steps.length) {
          try {
            ...
            const response = await hApi.put(`/sales/${id}`, payload);

            if (response.data.success) {
              toast.success("Helicopter listing updated successfully!");
              window.location.href =
                "/h-broker/preview/" + response.data.helicopter.id;
            } else {
              throw new Error(
                response.data.message || "Failed to update helicopter listing"
              );
            }
          } catch (error) {
            ...
            toast.error(
              error instanceof Error
                ? error.message
                : "Failed to update helicopter listing. Please try again."
            );
          }
        } else {
          handleNextStep();
        ...
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update basic information about the helicopter.
            </p>
      ...
      case 2:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update technical specifications and passenger capacity.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <InputField
      ...
      case 3:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update details about the helicopter's condition and history.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <InputField
                label="Condition"
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update pricing information for the helicopter sale.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <div>
                <label
      ...
      case 5:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update onboard features and equipment.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
      ...
      case 6:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update visual assets to showcase your helicopter.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <FileUpload
      ...
      case 7:
        return (
          <div className="space-y-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Update additional equipment included with the sale.
            </p>
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                <InputField
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Edit Helicopter Sale Listing
          </h1>
          <p className="mt-3 text-xl text-gray-500">
            Update your helicopter listing
          </p>
        </div>
